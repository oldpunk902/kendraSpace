...
(function () {
    ...
    onvisible.add('#text02', { style: 'blur-in', speed: 1750, intensity: 5, delay: 750, staggerOrder: '', replay: false });
    onvisible.add('#text04', { style: 'blur-in', speed: 1625, intensity: 5, delay: 875, staggerOrder: '', replay: false });
    onvisible.add('#text03', { style: 'blur-in', speed: 1500, intensity: 5, delay: 1375, staggerOrder: '', replay: false });
    onvisible.add('#list01', { style: 'blur-in', speed: 1000, intensity: 5, delay: 1500, stagger: 1000, replay: false });
    onvisible.add('#text01', { style: 'fade-in', speed: 1000, intensity: 5, delay: 5000, staggerOrder: '', replay: false });
    onvisible.add('#container01', { style: 'blur-in', speed: 1625, intensity: 5, delay: 125, staggerOrder: '', replay: false });
    onvisible.add('#image01', { style: 'blur-in', speed: 1000, intensity: 6, delay: 125, staggerOrder: '', replay: false });
    onvisible.add('#icons01', { style: 'blur-in', speed: 1500, intensity: 7, delay: 5000, stagger: 2250, replay: false });
